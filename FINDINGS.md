...
| Core bundle < 30 KB min+gzip, zero runtime deps | ✓ 10.34 KB gzip at validation, 0 deps (the library has since grown: ~21 KB core / ~39 KB full barrel — see `pnpm size`) |
