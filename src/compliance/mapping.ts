...
export const CHECK_CATALOG: readonly CheckSpec[] = [
  ...
  { id: 'single-pointer-pan', sc: ['2.5.7'], verification: 'automated' },
  ...
  { id: 'resize-text-rem', sc: ['1.4.4'], verification: 'automated' },
  { id: 'reflow', sc: ['1.4.10'], verification: 'automated' },
  { id: 'reflow-adaptive', sc: ['1.4.10'], verification: 'automated' },
  ...
  { id: 'forced-colors-canvas', sc: ['forced-colors', '1.4.11'], verification: 'automated' },
  { id: 'contrast-marks', sc: ['1.4.11'], verification: 'hybrid' },
