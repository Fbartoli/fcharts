...
export const CHECK_CATALOG: readonly CheckSpec[] = [
  ...
  { id: 'text-alternative', sc: ['1.1.1', '1.3.1'], verification: 'automated' },
  { id: 'table-x-header', sc: ['1.3.1', '2.4.6'], verification: 'automated' },
  { id: 'surface-semantics', sc: ['1.1.1', '4.1.2'], verification: 'automated' },
  { id: 'legend-semantics', sc: ['1.3.1', '4.1.2'], verification: 'automated' },
  ...
  { id: 'forced-colors-rule', sc: ['2.4.7', 'forced-colors'], verification: 'automated' },
  { id: 'focus-visible', sc: ['2.4.7'], verification: 'automated' },
