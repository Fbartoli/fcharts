...
Pack: auto-VPAT generator, `sightline-audit` CI gate, conformance engine) is already built.
...
| Product | [Wire `sightline/compliance` entry + `sightline-audit` bin into the build](./productize.md#compliance-build) | **P0** | ☐ |
...
| Product | [React adapter `<SightlineChart>`](./productize.md#react-adapter) | P1 | ☐ |
